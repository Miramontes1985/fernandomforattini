...
export const publicationSections: PublicationSection[] = [
  {
    ...
    intro: {
      ...
      es: "Trabajos sobre corrupción, reformas institucionales, capacidad estatal, servicios públicos, opacidad y fallas de gobernanza.",
    },
    items: [
      {
        featured: true,
        meta: {
          ...
          es: "Capítulo de libro · Cambridge University Press · 2026",
        },
        citation: {
          ...
          es: "Forattini, F. M. (2026). The contingency of mobilization: The social contexts of Operation Lava Jato in Brazil. In A comparative historical sociology of corruption (pp. 214-230). Cambridge University Press.",
        },
      },
      {
        meta: {
          ...
          es: "Artículo · American Behavioral Scientist · 2026",
        },
        citation: {
          ...
          es: "Forattini, F. (2026). Beyond “best practices”: A historical-sociological critique of privatization, decentralization, and anti-corruption reforms in 1990s Brazil. American Behavioral Scientist.",
        },
      },
      {
        meta: {
          ...
          es: "Artículo · Journal of Interdisciplinary History / MIT Press · 2026",
        },
        citation: {
          ...
          es: "Forattini, F. (2026). The rise and evolution of anti-corruption impulses in the United States and Brazil. Journal of Interdisciplinary History. MIT Press.",
        },
      },
      {
        meta: {
          ...
          es: "Capítulo de libro · Palgrave Macmillan · 2026",
        },
        citation: {
          ...
          es: "Forattini, F., Gillanders, R., Connolly, R., & Aja-Eke, D. (2026). Fighting sexual corruption in public services: Lessons from women’s experiences in Brazil. In Anti-Corruption Policy for Female Empowerment and Gender Equality. Palgrave Macmillan.",
        },
      },
      {
        meta: {
          ...
          es: "Capítulo de libro · Routledge · 2026",
        },
        citation: {
          ...
          es: "Connolly, R., Forattini, F., & Gillanders, R. (2026). Corruption and SDG 11: Sustainable cities and communities. In R. Gillanders & C. K. Jha (Eds.), Corruption and the Sustainable Development Goals. Routledge.",
        },
      },
      {
        meta: {
          ...
          es: "Artículo · Journal of Public Governance and Policy · 2024",
        },
        citation: {
          ...
          es: "Forattini, F. M. (2024). Corruption consolidation in local governments: Networks, opacity, and governance failures. Journal of Public Governance and Policy: Latin American Review, 91-113.",
        },
      },
      {
        meta: {
          ...
          es: "Artículo enviado · Public Administration",
        },
        citation: {
          ...
          es: "Forattini, F., Gillanders, R., & Connolly, R. (enviado). Anticipatory deterrence and sexual corruption in public services: Silence, withdrawal, inequality. Public Administration.",
        },
      },
    ],
  },
  {
    ...
    intro: {
      ...
      es: "Trabajos sobre categorías raciales, reconocimiento indígena, desigualdad, datos sociales, vulnerabilidad y política ambiental.",
    },
    items: [
      {
        featured: true,
        meta: {
          ...
          es: "Capítulo de libro · Oxford University Press · 2026",
        },
        citation: {
          ...
          es: "Forattini, F., & Miranda Braga, B. (2026). The weight of the “pardo” category: Official statistics and the deracialization of Indigenous peoples. In Oxford Intersections: Racism by Context. Oxford University Press.",
        },
      },
      {
        meta: {
        ...
        citation: {
          ...
          es: "Forattini, F. M., & Clarete, L. (2023). Producción y reproducción de desigualdades sociales relacionadas con COVID-19 expresadas en redes sociales. Cronos, 24(1), 38-66.",
        },
      },
      {
        meta: {
          ...
          es: "Artículo · European Review of Latin American and Caribbean Studies · 2020",
        },
        citation: {
          ...
          es: "Forattini, F. (2020). Piripkura: The plight of Indigenous people, environment, and Brazilian identity. European Review of Latin American and Caribbean Studies, (110).",
        },
      },
      {
        meta: {
          ...
          es: "En evaluación · Leiden University Press",
        },
        citation: {
          ...
          es: "Forattini, F. (en evaluación). Environmental warfare in the Brazilian Amazon: Militarized development and human and environmental destruction in Brazil. Leiden University Press.",
        },
      },
    ],
  },
  {
    ...
    intro: {
      ...
      es: "Trabajos sobre IA responsable, servicios públicos digitales, ética del cuidado, tecnología con enfoque de género, sextorsión y sistemas de información.",
    },
    items: [
      {
        featured: true,
        meta: {
          ...
          es: "Artículo · Information Systems Management · 2026",
        },
        citation: {
          ...
          es: "Forattini, F., & Connolly, R. (2026). Prometheus ambition, Zeusian order: Why leaps in information systems require structurally aware ethical frameworks. Information Systems Management.",
        },
      },
      {
        meta: {
          ...
          es: "Artículo · ACM SIGMIS Database · 2026",
        },
        citation: {
          ...
          es: "Forattini, F., & Connolly, R. (2026). From design to policy: Embedding care ethics and STEM institutional insights in gender-focused technology. ACM SIGMIS Database: The DATABASE for Advances in Information Systems.",
        },
      },
      {
        meta: {
          ...
          es: "Artículo · ACM SIGMIS Database · 2025",
        },
        citation: {
          ...
          es: "Forattini, F., Connolly, R., & Joshi, K. D. (2025). Breaking boundaries: Advancing gender and technology research to combat sextortion. ACM SIGMIS Database: The DATABASE for Advances in Information Systems, 56(1).",
        },
      },
      {
        meta: {
          ...
          es: "Actas de conferencia · HICSS · 2025",
        },
        citation: {
          ...
          es: "Forattini, F. M. (2025). Gender-focused technology design and care ethics integration: Addressing social and practical challenges. In Proceedings of the 58th Hawaii International Conference on System Sciences.",
        },
      },
      {
        meta: {
          ...
          es: "En evaluación · European Journal of Information Systems",
        },
        citation: {
          ...
          es: "Forattini, F., & Connolly, R. (en evaluación). When Promethean leaps meet institutional power: Designing digital public services through a care-ethical lens. European Journal of Information Systems.",
        },
      },
      {
        meta: {
          ...
          es: "Trabajo de conferencia enviado · HICSS",
        },
        citation: {
          ...
          es: "Forattini, F., Connolly, R., & Almeida, J. (enviado). When stronger configurations are not enough: Auditing AI agents in gender-sensitive public service encounters. In 60th Hawaii International Conference on System Sciences.",
        },
      },
    ],
  },
  {
    ...
    intro: {
      ...
      es: "Trabajos sobre cultura política, medios, liberalismo, repertorios culturales, humor e institucionalización del poder autoritario.",
    },
    items: [
      {
        meta: {
          ...
          es: "Artículo · Projeto História · 2023",
        },
        citation: {
          ...
          es: "Forattini, F., & Longhi, C. R. (2023). Libertad y liberalismo: tensiones y disputas en el contexto de los Congresos Brasileños de Escritores de 1940. Projeto História.",
        },
      },
      {
        meta: {
          ...
          es: "Artículo · Domínios da Imagem · 2023",
        },
        citation: {
          ...
          es: "Forattini, F., & Andreotti, B. (2023). Superman y el giro conservador de Reagan: Una reflexión sobre el imaginario heroico en la cultura política de Estados Unidos (1978-1986). Domínios da Imagem, 17(33).",
        },
      },
      {
        meta: {
          ...
          es: "Artículo · Letras & Letras · 2020",
        },
        citation: {
          ...
          es: "Forattini, F. (2020). Humor en tiempos de cólera: el humor como discurso de resistencia al golpe. Letras & Letras.",
        },
      },
      {
        meta: {
          ...
          es: "Artículo · Captura Críptica · 2020",
        },
        citation: {
          ...
          es: "Forattini, F. (2020). La institucionalización del golpe de 1964 mediante un análisis del Acto Institucional nº 1 y de los grandes medios. Captura Críptica.",
        },
      },
    ],
  },
...
export const bookSections: PublicationSection[] = [
  {
    ...
    intro: {
      ...
      es: "Libros de autor listados en el CV.",
    },
    note: {
      ...
      es: "Estos libros se encuentran en importantes bibliotecas universitarias y públicas del mundo, incluidas The British Library, U.S. Library of Congress, Yale, Harvard, Princeton, Stanford, entre otras.",
    },
    items: [
      {
        meta: {
          ...
          es: "Libro · Brazil Publishing · 2020",
        },
        citation: {
          ...
          es: "Forattini, F. (2020). Desmitificando el gobierno de Castelo Branco y su relación con los grandes medios. Brazil Publishing.",
        },
      },
      {
        meta: {
        ...
        citation: {
          ...
          es: "Forattini, F. (2020). ¡Fue golpe! El humor como resistencia al golpe militar y sus discursos legitimadores. Ape’Ku.",
        },
      },
    ],
  },
  {
    ...
    intro: {
      ...
      es: "Volúmenes editados listados en el CV.",
    },
    items: [
      {
        meta: {
      ...
      },
      {
        meta: {
          ...
          es: "Libro editado · Brazil Publishing · 2020",
        },
        citation: {
          ...
          es: "Forattini, F. (Ed.). (2020). Corrupción: qué es, cómo nos afecta y formas de combatirla. Brazil Publishing.",
        },
      },
    ],
  },
